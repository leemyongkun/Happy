...
public class RefreshableSqlSessionFactoryBean extends SqlSessionFactoryBean implements DisposableBean{
	 private static final Log log = LogFactory.getLog(RefreshableSqlSessionFactoryBean.class);
	    ...
	    /**
	     * ?åå?ùº Í∞êÏãú ?ì∞?†à?ìúÍ∞? ?ã§?ñâÏ§ëÏù∏Ïß? ?ó¨Î∂?.
	     */
	    ...
	    /**
	     *
	     * ?ã±Í∏??Ü§ Î©§Î≤ÑÎ°? SqlSessionFactory ?õêÎ≥? ???ã† ?îÑÎ°ùÏãúÎ°? ?Ñ§?†ï?ïò?èÑÎ°? ?ò§Î≤ÑÎùº?ù¥?ìú.
	     */
	                ...
	                else if( configLocation != null )
	                {
	                    ...
	                    if (xmlConfigBuilder != null) {
	                        try {
	                            ...
	                            // Configuration ?Å¥?ûò?ä§?ùò protected member field ?ù∏ loadedResources Î•? ?ñªÍ∏? ?úÑ?ï¥ reflection ?ùÑ ?Ç¨?ö©?ï®.
